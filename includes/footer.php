<footer class="ftco-footer ftco-section img">
        ...
        <div class="row mb-5">
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>I am a passionate Freelance Web & AI Developer with experience in building modern, scalable, and user-friendly applications. I work with MERN stack, Laravel, React, Next.js, MySQL, and cloud platforms to deliver reliable digital solutions. I focus on clean code, smart design, and timely delivery to help clients turn ideas into impactful products.</p>
          ...
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Beed Bypass MIT Chh. Sambhajinagar 431010</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 8208211725</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">mohanbirajdar41@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://mohanbirajdar.github.io/Mohan" target="_blank">Mohan Birajdar</a>
